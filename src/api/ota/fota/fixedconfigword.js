...
export function listConfigWord(fixedConfigWordId) {
  return request({
    url: '/ota-fota/mpt/fixedConfigWord/' + fixedConfigWordId + '/configWord',
    method: 'get'
  })
}
...
export function getConfigWord(fixedConfigWordId, configWordId) {
  return request({
    url: '/ota-fota/mpt/fixedConfigWord/' + fixedConfigWordId + '/configWord/' + configWordId,
    method: 'get'
  })
}
...
export function delConfigWord(fixedConfigWordId, configWordIds) {
  return request({
    url: '/ota-fota/mpt/fixedConfigWord/' + fixedConfigWordId + '/configWord/' + configWordIds,
    method: 'delete'
  })
}
