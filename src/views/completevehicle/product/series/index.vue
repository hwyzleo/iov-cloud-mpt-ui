<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['completeVehicle:product:series:add']"
        >新增
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['completeVehicle:product:series:edit']"
        >修改
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['completeVehicle:product:series:remove']"
        >删除
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['completeVehicle:product:series:export']"
        >导出
        </el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="seriesList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="车系代码" prop="code" width="120"/>
      <el-table-column label="车系名称" prop="name" width="150"/>
      <el-table-column label="车系英文名称" prop="nameEn" width="150"/>
